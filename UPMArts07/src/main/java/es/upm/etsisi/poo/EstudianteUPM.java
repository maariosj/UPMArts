...
public class EstudianteUPM extends MiembroUPM {
    ...
    public EstudianteUPM(String nick, String nombre, String correo, String contrasenaCifrada, boolean yaCifrada, String dni, String tarjetaCredito, String matricula) {
